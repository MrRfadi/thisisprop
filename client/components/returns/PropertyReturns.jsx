...
function PropertyReturns({ calculations, headerClicked }) {
  ...
  if(growth - fiveYearGrowth > 1) clr = 'red';
  else if(growth - fiveYearGrowth >= -1 && growth - fiveYearGrowth <= 1) clr = 'blue';
  else if(growth - fiveYearGrowth < -1) clr = 'green';


  const data = [
    
    { name: 'Assumed Growth', value: growth, color: clr },
    ...
    <section className="ReturnsContainer-section is-active">
      ...
      <div className="ReturnsContainer-values">
        <ul>
          ...
          <li className="ReturnsContainer-stampDuty">
