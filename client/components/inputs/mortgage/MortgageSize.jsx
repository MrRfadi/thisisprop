...
class MortgageSize extends Component {
  componentDidMount() {
    ...
    tl.to(slides[0], 0.5, { display: 'block' })
      .to(slides[0], 0.5, { display: 'none' }, "+=3")
      .to(slides[1], 0.5, { display: 'block' })
      .to(slides[1], 0.5, { display: 'none' }, "+=3")
      .to(slides[2], 0.5, { display: 'block' })
      .to(slides[2], 0.5, { display: 'none' }, "+=3")
  }
  ...
  render() {
    ...
    return (
      <div className="PurchaseSection-MortgageSize u-formInput">
        ...
        <div className="Subscont" ref={ref => this.carousel = ref}>          
